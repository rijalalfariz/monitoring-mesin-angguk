            ...
            <div class="content">
                ...
                <div class="device-table lg">
                    <div class="head-table">
                        ...
                        <span class="head-table-text" style="width: 126px; min-width: 120px;">Kuota</span>
                        ...
                        @forelse ($devices_ampere as $device)
                            <div class="table-content-item
                             ...
                             " data-deviceid="{{ $device->id }}">
                                ...
                                <span class="head-table-text DeviceName" style="width: 125px; min-width: 108px;" data-name="{{ $device->name }}">{{ $device->name }}</span>
                                ...
                                <span class="head-table-text DeviceQuota elipsis1 pointable" style="width: 126px; min-width: 120px;" data-toggle="tooltip" data-placement="right" data-title="{{  $device->quota }}"
                                    data-template='

            ...
            <div class="content">
                ...
                <div class="device-table">
                    <div class="head-table">
                        ...
                        <span class="head-table-text" style="width: 180px">Nama Mesin</span>
                        <span class="head-table-text" style="width: 120px">Status Mesin</span>
                        <span class="head-table-text" style="width: 180px">Kuota</span>
                        <span class="head-table-text" style="width: 60px">Baterai</span>
                        <span class="head-table-text" style="width: 60px">Ampere</span>
                        ...
                        @forelse ($devices_ampere as $device)
                            <div class="table-content-item
                             ...
                             " data-deviceid="{{ $device->id }}">
                                ...
                                <span class="head-table-text DeviceQuota elipsis1 pointable" style="width: 180px" data-toggle="tooltip" data-placement="right" data-title="{{  $device->quota }}"
                                    data-template='
                                    ...
                                    '
                                    >{{ $device->quota }}</span>
                                <span class="head-table-text DeviceBattery" style="width: 60px">{{ $device->battery }} %</span>
                                <span class="head-table-text DeviceAmpere" style="width: 60px">{{ $device->ampere }}</span>
                ...
                <div class="device-table">
                    <div class="head-table">
                        ...
                        <span class="head-table-text" style="width: 180px">Kuota</span>
                        <span class="head-table-text" style="width: 60px">Baterai</span>
                        <span class="head-table-text" style="width: 60px">Tegangan</span>
                        <span class="head-table-text text-center" style="width: 120px">Aksi</span>
                    </div>
                    <div class="table-content">
                            ...
                            @if ($device->tipe_device == 1)
                                ...
                                " data-deviceid="{{ $device->id }}">
                                    ...
                                    <span class="head-table-text DeviceQuota elipsis1 pointable" style="width: 180px" data-toggle="tooltip" data-placement="right" data-title="{{  $device->quota }}"
                                        ...
                                        >{{ $device->quota }}</span>
                                    <span class="head-table-text DeviceBattery" style="width: 60px">{{ $device->battery }} %</span>
                                    <span class="head-table-text DeviceTegangan" style="width: 60px">{{ $device->tegangan }}</span>
                                    <span class="head-table-text text-center d-flex justify-content-center AcitionColumn" style="width: 120px">
                                        <button class="OriginalBtnGroup aksi-button bg-f0 mr-3 EditBtn">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.4998 7.64331e-05L15.4998 3.00009L5.49983 13.0001L2.49968 10.0001L12.4998 7.64331e-05Z" fill="white"/>

            ...
            <div class="content">
                ...
                <div class="device-table lg">
                    <div class="head-table">
                        ...
                        <span class="head-table-text @if ( Auth::user()->position_id != 1 ) div-grow @endif" style="width: 125px; min-width: 108px;">Nama Mesin</span>
                        <span class="head-table-text" style="width: 108px; min-width: 108px;">Status Mesin</span>
                        <span class="head-table-text @if ( Auth::user()->position_id != 1 ) div-grow @endif" style="width: 126px; min-width: 120px;">Kuota</span>
                        ...
                        @if ( Auth::user()->position_id == 1 )
                            <span class="head-table-text text-center" style="width: 120px; min-width: 76px;">Aksi</span>
                        @endif
                        <span class="head-table-text" style="width: 120px; min-width: 120px;">History Mati</span>
                    </div>
                        ...
                        @forelse ($devices_ampere as $device)
                            <div class="table-content-item
                             ...
                             " data-deviceid="{{ $device->id }}">
                                ...
                                <span class="head-table-text DeviceName @if ( Auth::user()->position_id != 1 ) div-grow @endif" style="width: 125px; min-width: 108px;" data-name="{{ $device->name }}">{{ $device->name }}</span>
                                <span class="head-table-text status{{ $device->status }} DeviceStatus ff-bold" style="width: 108px; min-width: 108px;">
                                @if ($device->status == 1)
                                    Berjalan
                                @else
                                    Berhenti
                                ...
                                <span class="head-table-text DeviceQuota elipsis1 pointable @if ( Auth::user()->position_id != 1 ) div-grow @endif" style="width: 126px; min-width: 120px;" data-toggle="tooltip" data-placement="right" data-title="{{  $device->quota }}"
                                    data-template='
